...
def y_repeat(input_line, snv_seq_size,ref_fasta,ins_factor,del_factor):
    ...
    input_chr = 'chr' + input_split[0] #수정: 'chr' + 추가함
    input_pos = int(input_split[1]) #수정: python2는 long
    new_lt_size = 0
    new_rt_size = 0
...
#ref_fa='/home/mjkim/Ref.seq/GRCm38.p4.genome/GRCm38.p4.genome.fa'
#ref_fa='/home/mjkim/Ref.seq/human_g1k_v37/human_g1k_v37.fasta'
...
if temp == 1:
    ...
    in_file=open('/home/mjkim/exercise_221125/03_strelka2/N1-S1_snp_union_2.vcf')
    t_file=pysam.AlignmentFile('/home/mjkim/exercise_221125/02_bam/N1-S1.s.md.bam','rb') #tumor bam file
    n_file=pysam.AlignmentFile('/home/mjkim/exercise_221125/02_bam/N1-spleen.s.md.bam','rb') #normal bam file
    ref_fa='/home/mjkim/Ref.seq/GRCm38.p4.genome/GRCm38.p4.genome.fa'
    r_file=pysam.FastaFile(ref_fa)
...
#return [new_lt_size,new_rt_size,lt_max_snv_lt_size,temp_max_snv_rt_size,lt_max_snv_ru,temp_max_snv_ru]
        ...
        #for read in t_file.fetch('chr1',pos1-1,pos1): 수정: fetch(,) 첫번째는 str 형식이어야함(pysam 버전 변경이 원인일 것으로 예상)
