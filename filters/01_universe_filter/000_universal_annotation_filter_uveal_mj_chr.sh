...
#(gzip -dc /home/mjkim/exercise_221125/03_strelka2/$1/results/variants/somatic."$temp_mttype"s.vcf.gz > /home/mjkim/temp/somatic."$temp_mttype"s.vcf) &>> $log || { c=$?;echo "Error";exit $c; }
#echo "done" >>$log
