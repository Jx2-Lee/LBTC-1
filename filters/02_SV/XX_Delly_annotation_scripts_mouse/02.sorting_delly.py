...
while in_line:
    ...
    in_indi[0]=in_indi[0].replace('chr','')
    if in_line[0]=='#':
        out_file.write(in_line+'\n')
    else:
        n_chr1=in_indi[0]
        n_chr2=(in_indi[7].split('CHR2=')[1]).split(';')[0].replace('chr','')
        ...
        if in_indi[0][0:2]=='GL':
            ...
            chr=int(((in_indi[0].replace('X','23')).replace('Y','24')).replace('M','25'))
        ...
        if n_chr2[0:2]=='GL':
            ...
            chr2=int(((n_chr2.replace('X','23')).replace('Y','24')).replace('M','25'))
