...
input_fn = sys.argv[1]
input_file = open(input_fn + '.delly.vcf.somatic.annotated')

output_file = open(input_fn +'.delly.somatic.annotated.filter1.vcf' , 'w')
...
while input_line:
    ...
    if input_split[20] == 'INS' and input_split[9].split(':')[0] == '0/1':
        ...
        if input_split[20] == 'TRA':
            ...
            #수정 전: input_size = long(input_split[17]) - long(input_split[15])
            input_size = int(input_split[17]) - int(input_split[15])
